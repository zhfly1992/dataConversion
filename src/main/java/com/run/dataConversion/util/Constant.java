...
//    public static final String SECRET = "b0pcUQYHNHxiaCZm8KQfCUuLo0Aa";
    ...
    //成华区华为平台正式环境
    public static final String APPID = "2mtJXSO5QgKMCPMVF_6gMKJaUUca";
    public static final String SECRET = "qBq6tRfM9VoqesgjgR3Ced3_dlka";
...
//    public static String SELFCERTPATH = "/src/main/resource/cert/server.crt";
//    public static String TRUSTCAPATH = "/src/main/resource/cert/server.key";
    
    //Password of certificates.
    public static String SELFCERTPWD = "IoM@1234";
    public static String TRUSTCAPWD = "Huawei@123";

//    public static String SELFCERTPWD = "111111";
//    public static String TRUSTCAPWD = "111111";
     ...
     * */
    public static final String DEVICE_INFO_LIST = BASE_URL+"/iocm/app/dm/v1.4.0/devices";
