...
public class HttpsUtil extends DefaultHttpClient {
	 ...
	 * */
	public void initSSLConfigForTwoWay(String applicationId) throws Exception {
		// 1 Import your own certificate
		String demo_base_Path = System.getProperty("user.dir");
//		demo_base_Path = FileUtil.getPantentPath(demo_base_Path,2)+"cert"+File.separator;
		String selfcertpath = demo_base_Path + Constant.SELFCERTPATH;
		String trustcapath = demo_base_Path + Constant.TRUSTCAPATH;
//		String selfcertpath = demo_base_Path +applicationId+".pkcs12";
//		String trustcapath = demo_base_Path +applicationId+".jks" ;
